...
*   **A short tagline.** This will appear under the name of your project on https://docs.publiq.be and must be under 35 characters to avoid an ellipsis. For example `Integrate with the UiTdatabank APIs`.
